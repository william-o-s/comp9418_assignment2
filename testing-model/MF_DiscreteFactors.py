...
class Factor:
    ...
    def __getitem__(self, outcomes):
        ...
        indices = tuple(self.outcome_space[var].index(outcomes[i]) for i, var in enumerate(self.domain))
    ...
    def evidence(self, **kwargs):
        ...
        for var, value in evidence_dict.items():
            if var in f.domain:
                ...
                index = f.outcome_space[var].index(value)
    ...
    def __str__(self):
        ...
        '''
        table = []
        outcomeSpaces = [self.outcome_space[var] for var in self.domain]
